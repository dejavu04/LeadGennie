...
export default function Header() {
  ...
  return (
    <Navbar className='border-b-2'>
      ...
      <Button className='w-12 h-10 lg:hidden mr-4' color='gray' pill>
        <AiOutlineSearch />
      </Button>
      ...
      <div className='flex gap-2 md:order-2'>
        ...
        <Button
          className='w-12 h-10 hidden sm:inline mr-4'
          color='gray'
          pill
      ...
      <Navbar.Collapse>
        ...
        <Navbar.Link active={path === '/'} as={'div'} className="mr-4">
          <Link to='/'>Home</Link>
        </Navbar.Link>
        <Navbar.Link active={path === '/about'} as={'div'} className="mr-4">
